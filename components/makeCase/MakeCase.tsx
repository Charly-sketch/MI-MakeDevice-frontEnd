          ...
          <div className="model-selector">
            ...
            {selectedModelIndex !== null && (
              <button
                ...
                onClick={() => {
                  setModels((prevModels) =>
                    prevModels.map((mod, idx) => {
                      if (idx !== selectedModelIndex) return mod;
                      const allVisible = mod.stlUrls.every(
                        (stl) => stl.visible,
                      );
                      const stlUrls = mod.stlUrls.map((stl) => ({
                        ...stl,
                        visible: !allVisible,
                      }));
                      return { ...mod, stlUrls };
                  ...
                  {selectedStlIndex === idx && (
                    <div style={{ marginLeft: 10, marginTop: 6 }}>
                      ...
                      <div>
                        ...
                        <button
                          onClick={() => {
                            ...
                            const pos = mod.stlUrls[idx].position || {
                              x: 0,
                              y: 0,
                              z: 0,
                            };
                      ...
                      <div style={{ marginTop: 4 }}>
                        ...
                        />
                        <button
                          onClick={() => stlScale(selectedModelIndex, idx)}
                          style={{ marginLeft: 5 }}
                        >
                          Apply Scale
                        </button>
                  ...
                  {Object.entries(caseParams).map(([key, value]) => (
                    <div key={key} className="param-row">
                      ...
                      <input
                        ...
                        value={value}
                        onChange={(e) =>
                          handleOptionChange(key, parseFloat(e.target.value))
                        }
                      />
                    </div>
                  ))}

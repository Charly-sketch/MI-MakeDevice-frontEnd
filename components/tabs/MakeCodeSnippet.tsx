...
export class MakeCodeSnippet extends React.Component<
  SnippetProps,
  SnippetState
> {
  ...
  constructor(props: SnippetProps) {
    ...
    this.debouncedRenderProps = MakeCodeSnippet.debounce(
      this.renderProps,
  ...
  UNSAFE_componentWillReceiveProps(nextProps: SnippetProps) {
    if (
